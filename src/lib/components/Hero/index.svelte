	...
	<div class="px-4 sm:px-8 lg:w-1/2 xl:pr-16">
		...
		<div class="mt-10 sm:flex sm:justify-center lg:justify-start">
			<div class="rounded-md shadow">
				<a
					href="#"
					class="flex w-full items-center justify-center rounded-md border border-transparent bg-teal-500 px-8 py-3 text-base font-medium !text-white hover:bg-teal-600 md:py-4 md:px-10 md:text-lg"
					>Get started</a
				>
			</div>
